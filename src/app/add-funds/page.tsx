...
export default function AddFundsPage() {
  ...
  const [utr, setUtr] = useState(""); // For manual backup
  ...
  const handleAutomatedPay = async () => {
    if (!user || !amount || parseFloat(amount) < 10) {
    ...
    try {
      ...
      toast({ variant: "destructive", title: "Gateway Error", description: error.message || "Try again later." });
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-[#F0F2F5] font-body text-[#111B21] pb-20">
      ...
      <main className="max-w-md mx-auto p-6 space-y-6 mt-4">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 shadow-xl border border-gray-50 space-y-8">
          {activeTab === 'automated' ? (
            <div className="space-y-6">
              ...
              <div className="bg-blue-50/50 p-4 rounded-2xl flex items-start gap-3 border border-blue-100/50">
                ...
                <p className="text-[10px] font-bold text-blue-600 uppercase leading-relaxed">
                  Money will be credited instantly after successful payment via UPI Gateway.
                </p>
              </div>
              ...
              <Button 
                ...
                className="w-full h-16 bg-[#312ECB] hover:bg-[#2825A6] text-white rounded-[1.5rem] font-black text-[13px] uppercase tracking-widest shadow-2xl gap-3"
              >
            ...
            <div className="space-y-6 text-center py-4">
              ...
              <h3 className="text-sm font-black uppercase">Manual System Active</h3>
              <p className="text-[11px] font-bold text-slate-400 uppercase leading-relaxed">
                Manual payment system is currently available as a backup. Please contact admin on WhatsApp for instructions.
              </p>
              <Button 
                variant="outline"
        ...
        <button 
          ...
          className="w-full bg-white rounded-2xl p-5 flex items-center justify-between border border-gray-100 shadow-sm"
        >
          <div className="flex items-center gap-3">
            <History className="text-slate-400" size={20} />
            <span className="text-[11px] font-black uppercase tracking-widest">Payment History</span>
          </div>
