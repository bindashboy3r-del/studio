...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-screen max-w-lg mx-auto overflow-hidden relative shadow-3d bg-white dark:bg-slate-950 font-body">
      <header className="glass-header px-4 py-3 flex items-center justify-between shadow-3d-sm">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-xl bg-[#312ECB] flex items-center justify-center text-white shadow-3d-sm"><Zap className="fill-current" size={16} /></div>
